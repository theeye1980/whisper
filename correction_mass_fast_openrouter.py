...
# model = "gpt-4o-mini"
# model="moonshotai/kimi-dev-72b:free" # Не годится для этой цели
model="tngtech/deepseek-r1t2-chimera:free"

temperatura = 0.1
helper = "Analyze the text below. Add commas and periods, as well as capitalize where appropriate. Do not change or add anything else. Do not print pondering. Keep timestamps as they are. Just return corrected text only:"
...
def correction(chunks, file_path):
    ...
    for idx, chunk in enumerate(chunks):
        ...
        resp =  chatbot.chat_mode(model,prompt)
        print(resp)
        ...
        txt.save_string_to_file(file_path, resp)
